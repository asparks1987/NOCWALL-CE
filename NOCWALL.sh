...
NOCWALL_STRIPE_PAYMENT_LINK="${NOCWALL_STRIPE_PAYMENT_LINK:-}"
NOCWALL_STRIPE_PAYMENT_LINKS="${NOCWALL_STRIPE_PAYMENT_LINKS:-}"
NOCWALL_BILLING_DEFAULT_TIER="${NOCWALL_BILLING_DEFAULT_TIER:-pro_monthly}"
...
Options:
  ...
  --stripe-payment-link <u>
                          Stripe payment link URL (single default tier)
  --stripe-payment-links <s>
                          Tier map (json or k=v list), e.g. pro_monthly=https://...
  --billing-default-tier <tier>
                          Default tier key for payment-link checkout
...
parse_args() {
  while [[ $# -gt 0 ]]; do
    case "$1" in
      ...
      --stripe-payment-link)
        NOCWALL_STRIPE_PAYMENT_LINK="$2"; shift 2 ;;
      --stripe-payment-links)
        NOCWALL_STRIPE_PAYMENT_LINKS="$2"; shift 2 ;;
      --billing-default-tier)
        NOCWALL_BILLING_DEFAULT_TIER="$2"; shift 2 ;;
      --stripe-success-url)
...
NOCWALL_STRIPE_PAYMENT_LINK=$NOCWALL_STRIPE_PAYMENT_LINK
NOCWALL_STRIPE_PAYMENT_LINKS=$NOCWALL_STRIPE_PAYMENT_LINKS
NOCWALL_BILLING_DEFAULT_TIER=$NOCWALL_BILLING_DEFAULT_TIER
NOCWALL_STRIPE_SUCCESS_URL=$NOCWALL_STRIPE_SUCCESS_URL
NOCWALL_STRIPE_CANCEL_URL=$NOCWALL_STRIPE_CANCEL_URL
NOCWALL_STRIPE_PORTAL_RETURN_URL=$NOCWALL_STRIPE_PORTAL_RETURN_URL
EOF
